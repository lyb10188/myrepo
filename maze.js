...
function getFNeighboursnewNew(index, sx, sy, a) {
...
function solveMaze2(index) {
    ...
    var neighbours = getFNeighboursNew( 0, start[index].x, start[index].y, 0 );
    if( neighbours.length ) {
        stacks[index].push( start[index] );
        start[index] = neighbours[0];
        mazes[index][start[index].x][start[index].y] = 2;
...
function solveMaze2New(index) {
    ...
    var neighbours = getFNeighboursnewNew( 1, start[index].x, start[index].y, 0 );
    if( neighbours.length ) {
        stacks[index].push( start[index] );
        start[index] = neighbours[0];
        mazes[index][start[index].x][start[index].y] = 2;
